    ...
    return (
        <div className='p-4 rounded-md flex flex-col gap-4 bg-slate-950 sm:flex-wrap'>
            <div className='flex flex-col sm:flex-row sm:items-center sm:flex-wrap gap-x-4'>
                ...
                <h2 className='capitalize text-lg sm:text-xl md:text-2xl flex-1 sm:text-center break-words'>{exercise.name.replaceAll("_", " ")}</h2>
            ...
            <div className='grid grid-cols-2 sm:grid-cols-4 sm:place-items-center gap-2'>
                {['reps', 'rest', 'tempo'].map(info => {
                    return (
                        <div key={info} className='flex flex-col p-2 rounded border border-solid border-slate-900 w-full'>
                ...
                <button onClick={handleSetIncrement} className='flex flex-col p-2 rounded border border-solid border-blue-900 hover:border-blue-600 w-full duration-200'>
