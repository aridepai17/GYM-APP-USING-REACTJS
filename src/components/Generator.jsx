...
import { SCHEMES, WORKOUTS } from '../utils/shredder'
...
function Header({ index, title, description }) {
    return (
        <div className='flex flex-col gap-4'>
            ...
            <p className='text-sm md:text-base mx-auto'>{description}</p>
        </div>
    )
}
...
export default function Generator(props) {
    ...
    return (
        <SectionWrapper id={'generate'} header={'Generate your workout'} title={["It's", 'Shred', "o'clock"]}>
